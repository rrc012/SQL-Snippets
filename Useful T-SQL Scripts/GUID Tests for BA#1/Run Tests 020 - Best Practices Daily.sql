/**********************************************************************************************************************
 ...
 Defrag Daily per "Best Practice": Test for whether to defrag or not is executed daily.
    ...
    Baseline and NoDefrag runs were previously done by the "Defrag Weekly" code. (04:19:53)
-----------------------------------------------------------------------------------------------------------------------
 Operator Notes:
...
--===== Rename the table to keep it for later experiments
     IF OBJECT_ID('dbo.BPDD_FF100','U') IS NOT NULL
        DROP TABLE dbo.BPDD_FF100
;
   EXEC sp_rename 'dbo.GuidTest','BPDD_FF100'
;
-----------------------------------------------------------------------------------------------------------------------
...
;
--===== Rename the table to keep it for later experiments
     IF OBJECT_ID('dbo.BPDD_FF090','U') IS NOT NULL
        DROP TABLE dbo.BPDD_FF090
;
   EXEC sp_rename 'dbo.GuidTest','BPDD_FF090'
;
-----------------------------------------------------------------------------------------------------------------------
...
;
--===== Rename the table to keep it for later experiments
     IF OBJECT_ID('dbo.BPDD_FF080','U') IS NOT NULL
        DROP TABLE dbo.BPDD_FF080
;
   EXEC sp_rename 'dbo.GuidTest','BPDD_FF080'
;
-----------------------------------------------------------------------------------------------------------------------
...
;
--===== Rename the table to keep it for later experiments
     IF OBJECT_ID('dbo.BPDD_FF070','U') IS NOT NULL
        DROP TABLE dbo.BPDD_FF070
;
   EXEC sp_rename 'dbo.GuidTest','BPDD_FF070'
;
-----------------------------------------------------------------------------------------------------------------------
--=====================================================================================================================
